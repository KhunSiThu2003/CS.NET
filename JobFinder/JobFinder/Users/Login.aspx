<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="JobFinder.User.Login" %>
                        ...
                        <div class="login-card">
                            ...
                            <div class="login-form">
                                <div class="form-group">
                                    <label for="txtUsernameOrEmail" class="form-label">Username or Email</label>
                                    <asp:TextBox ID="txtUsernameOrEmail" runat="server" CssClass="form-control"
                                        placeholder="Enter your username or email"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvUsernameOrEmail" runat="server"
                                        ControlToValidate="txtUsernameOrEmail" ErrorMessage="Username or email is required"
